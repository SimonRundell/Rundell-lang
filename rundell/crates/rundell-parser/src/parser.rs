...
use crate::ast::{
    BinOp, CatchClause, CmpOp, DefineStmt, Expr, ForEachStmt, ForLoopStmt, FunctionDefStmt, IfStmt,
    Literal, Param, ReceiveStmt, RundellType, SetOp, SetStmt, SetTarget, Stmt, SwitchCase,
    SwitchPattern, SwitchStmt, TryCatchStmt, UnaryOp, WhileLoopStmt,
};
...
impl Parser {
    ...
    // define …  — dispatches to variable declaration or function definition
    fn parse_define_or_funcdef(&mut self) -> Result<Stmt, ParseError> {
        // Peek ahead to see if this is a function definition.
        // Forms:
    ...
    // Parse set target: Ident or Ident[expr][expr]...
